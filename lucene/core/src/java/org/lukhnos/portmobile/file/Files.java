...
public class Files {
    ...
    public static void main(String args[]) {
        System.out.println("Empty path exists? " + Files.exists(Paths.get("")));
        System.out.println("Absolute path exists? " + Files.exists(Paths.get("/usr")));
        System.out.println("Contents: " + Arrays.asList(new File("/tmp").listFiles()));
    }
}
